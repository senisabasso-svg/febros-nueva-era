...
(function(){
  ...
  const ALL = [
    { shot:'/assets/cards/card-0.jpg', kicker:'demo', name:'demo', chip:'demo', accent:'#FF9538' },
    { shot:'/assets/cards/card-1.jpg', kicker:'demo', name:'demo', chip:'demo', accent:'#C9992E' },
    { shot:'/assets/cards/card-2.jpg', kicker:'demo', name:'demo', chip:'demo', accent:'#C9992E' },
    { shot:'/assets/cards/card-3.jpg', kicker:'demo', name:'demo', chip:'demo', accent:'#FF9538' },
    { shot:'/assets/cards/card-4.jpg', kicker:'demo', name:'demo', chip:'demo', accent:'#C9992E' }
  ];
